...
class FlexivCmd(idl.IdlStruct):
    tau_ff: array[types.float64, 7] = field(default_factory=lambda: 7 * [0.0])
    q: array[types.float64, 7] = field(default_factory=lambda: 7 * [0.0])
    dq: array[types.float64, 7] = field(default_factory=lambda: 7 * [0.0])
    kp: array[types.float64, 7] = field(default_factory=lambda: 7 * [0.0])
    kv: array[types.float64, 7] = field(default_factory=lambda: 7 * [0.0])
    mode: int32 = 2
...
class FlexivState(idl.IdlStruct):
    ...
    ft_sensor: array[types.float64, 6] = field(
