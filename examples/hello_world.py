...
if args.mode == "sim":
    robot = sim_robot.FlexivSim(
        render=True, q0 = np.array([ 0.0, -0.698, 0.000, 1.571, -0.000, 0.698, -0.000 ]), pin_model=pin_model
    )
...
try:
    ...
    status = easy_controllers.run_controller(robot, 
