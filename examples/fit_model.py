...
for i,q in enumerate(qs_reduced):
    ...
    controller_status = easy_controllers.run_controller( robot, 
    easy_controllers.GoJointConfiguration(
            qdes =  q,
            max_v = .5 , 
            max_extra_time_rel = 1.) ,  dt=.002 , max_time = 30)
    ...
    easy_controllers.run_controller( robot, easy_controllers.Stay(), dt=.005 , max_time = 1.)
